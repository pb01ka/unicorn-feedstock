...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/unicorn-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/unicorn-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add python-unicorn unicorn
# for installing globally
pixi global install python-unicorn unicorn
```
...
It is possible to list all of the versions of `python-unicorn` available on your platform:
...
```
pixi search python-unicorn --channel conda-forge
```
